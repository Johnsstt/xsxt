...
class Main extends Component {
    ...
    render() {
        ...
        return (
            <div>
               <Header nav title='联系我们' HideList={this.showHide}/>               
               <section className='contact_content' ref='context' onClick={this.showHide.bind(this,'none')}>
                联系我们：0571-8889332
               </section>
