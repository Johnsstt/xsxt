...
class Main extends Component {
    ...
    componentWillReceiveProps(nextProps){
        ...
        if (this.props !== nextProps) {
            ...
            if (nextProps.productRecord.productList&&this.state.productList.length == 0) {
                this.state.shouldUpdata = true;
                this.state.productList = nextProps.productRecord.productList;
            ...
            if(nextProps.productRecord.id){
                let {productRecord} = nextProps;
                this.productsState(productRecord.id,productRecord.chooseState,productRecord.num,productRecord.index)
            }
        }     
    }
